...
const (
	RestService_Get_FullMethodName = "/rests.RestService/Get"
)
...
type RestServiceClient interface {
	Get(ctx context.Context, in *RestRequest, opts ...grpc.CallOption) (*RestResponse, error)
}
...
func (c *restServiceClient) Get(ctx context.Context, in *RestRequest, opts ...grpc.CallOption) (*RestResponse, error) {
...
type RestServiceServer interface {
	Get(context.Context, *RestRequest) (*RestResponse, error)
...
func (UnimplementedRestServiceServer) Get(context.Context, *RestRequest) (*RestResponse, error) {
...
func RegisterRestServiceServer(s grpc.ServiceRegistrar, srv RestServiceServer) {
	// If the following call pancis, it indicates UnimplementedRestServiceServer was
...
func _RestService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestServiceServer).Get(ctx, req.(*RestRequest))
	}
...
var RestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/rests/v1/rests.proto",
}
